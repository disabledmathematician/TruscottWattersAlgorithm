...
#	x1, y1 = Poisson(mean, np.e, rain)
	...
	ax2.title.set_text("Normal Distribution as probability of highest volume rain. Charles Truscott")
...
#	print(n)
	...
	ax3.title.set_text("Highest Volume of Daily Rainfall Byron Bay. Charles Truscott")
